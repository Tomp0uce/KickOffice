(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.OfficeWordDiff = {}));
	 ...
	 */
	async function applyBlockReplaceStrategy(context, range, newText, log) {
	 ...
	 */
	async function applySentenceDiffStrategy(context, range, text1, text2, log) {
	 ...
	 * @throws {Error} If all strategies fail
	 */
	async function applyTokenMapStrategy(context, range, originalText, newText, log) {
	 ...
	 */
	function createLogger(level = 'info', onLog = null) {
	 ...
	 * });
	 */
	async function applyWordDiff(context, range, originalText, newText, options = {}) {
	 ...
	 * @returns {DiffStats} Statistics about the diff
	 */
	function getDiffStats(text1, text2) {
	    const differ = new OfficeWordDiff({ logLevel: 'silent' });
	    return differ.getDiffStats(text1, text2);
	}

	exports.OfficeWordDiff = OfficeWordDiff;
	exports.applyBlockReplaceStrategy = applyBlockReplaceStrategy;
	exports.applySentenceDiffStrategy = applySentenceDiffStrategy;
	exports.applyTokenMapStrategy = applyTokenMapStrategy;
	exports.applyWordDiff = applyWordDiff;
	exports.computeDiff = computeDiff;
	exports.createLogCallback = createLogCallback;
	exports.createLogger = createLogger;
	exports.default = OfficeWordDiff;
