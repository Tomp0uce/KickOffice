<template>
  <div ref="containerEl" role="log" aria-live="polite" aria-relevant="additions text" class="flex flex-1 flex-col gap-4 overflow-y-auto rounded-md border border-border-secondary bg-surface p-2 shadow-sm">
